...
SECRET_KEY = 'django-insecure-3d5+$s_h8(i!+t+=3=g$a=ggth^m-4+@w*38)mp$4f0b4n_=5l'
...
INSTALLED_APPS = [
    ...
    'factuai',  # Nuestra aplicación principal
    'rest_framework',  # Para comunicación con la API
]
...
ROOT_URLCONF = 'plataforma_factuai.urls'
...
WSGI_APPLICATION = 'plataforma_factuai.wsgi.application'
